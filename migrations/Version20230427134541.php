 ...
 */
final class Version20230427134541 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE webpage CHANGE pathname pathname VARCHAR(1788) DEFAULT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX pathname_idx ON webpage');
        $this->addSql('ALTER TABLE webpage CHANGE pathname pathname VARCHAR(1795) DEFAULT NULL');
        $this->addSql('CREATE INDEX pathname_idx ON webpage (pathname(768))');
        $this->addSql('DROP INDEX parameter_idx ON webpage_parameter');
        $this->addSql('ALTER TABLE webpage_parameter CHANGE parameter parameter VARCHAR(255) NOT NULL');
    }
}
